...
One way to measure the prevalence of intersections is to define an temporal *intersection profile*
...
In empirical temporal hypergraphs, the intersection profile often $r_k^{(t)}$ decays at rates which are independent of $k$ and close to $t^{-1}$, *regardless of $k$*. 
...
[Dashed line gives slope of $t^{-1}$ decay.]{.footnote}
...
<br> <br> <br> <br> 
**Proposition**: There exist constants $q_k$ such that, as $m\rightarrow \infty$, 
