...
background-image: url("../img-lib/karate-graph-fade.png")
class:  
...
.row[
  .split-40[.column.bg-main1[
      ...
      <img src="../img-lib/heatmap-thumbnail.png" height=170px> 
      <img src="../img-lib/contact-clustering-excerpt.png" height=170px> 
...
.row[
  .split-40[.column.bg-main2[.content[
    ...
    <img src="../img-lib/karate-graph.png" height=160px>
    <img src="../img-lib/mxhierarchy-flows.png" height=170px> 
    <img src="../img-lib/dynamics-thumbnail.png" height=170px> 
...
.row[
  .split-40[.column.bg-main3[.content[
    ...
    <img src="../img-lib/sentencing-processing-thumbnail.png" height=170px> 
    <!-- <img src="../img-lib/mgp-thumbnail.png" height=170px>  -->
    <img src="../img-lib/no2-thumbnail.png" height=170px> 
...
- How can we actively use our quantitative and computational powers for .alert[social change]? 
  ]]
]
]
...
class: split-three fade-row3-col1 fade-row3-col2 fade-row2-col1 fade-row2-col2
layout: 
