...
<br> <br> 
*People who value control over life. 
...
$$Q \triangleq \sum_k \color{#ff5252}{\beta_k} \left[(\text{# homogeneous }k\text{-edges}) - \color{#21728f}{\gamma_k}\sum_{\ell} (\text{total degrees of nodes in cluster } \ell)^k\right]$$
