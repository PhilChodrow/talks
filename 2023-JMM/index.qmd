...
One very natural thing to do is to work on graphs induced from the the hypergraph, such as the clique-projection or bipartite representation. <br><br>

<img src="img/clique-projection.png" width=650 class="center">  

This is often reasonable and performant, but is Boring™ and can lead to poor results when not carefully checked against the data. 
...
[...You'll reason about some of the tradeoffs of addressing the absurd generality of hypergraph data. ]{.fragment .font-larger}

[...You'll describe at least one reason *why* it is hard to beat graph methods.]{.fragment .font-larger}


[...You'll know (my take on) interesting future directions for network data science with hypergraphs.]{.fragment .font-larger}
...
[**PSC**, N. Veldt, and A. R. Benson (2021). Generative hypergraph clustering: From blockmodels to modularity. *Science Advances*, 7:eabh1303]{.footnote}
...
### [Part III]{.alert} <br> Your Model Is Too [~~Complicated~~]{.fragment .semi-fade-out} Simple
